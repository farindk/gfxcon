...
static struct MsgData errormsgs_german[] =
{
  ...
  COULDNT_OPEN_WINDOW      , "Konnte das Fenster nicht öffnen",
  CANT_LOCK_WBSCREEN       , "Workbench konnte nicht verriegelt werden",
  CANT_CREATE_GADGET       , "Konnte Gadget  nicht erzeugen",
  COULDNT_OPEN_FILEREQ     , "Filerequester konnte nicht geöffnet werden",
  ...
  FILENAME_BUFFER_FULL     , "Speicher für Filename zu klein (BUG !!!)",
  ...
  WIN_DOESNT_FIT_ON_SCREEN , "Bildaufbau paßt nicht auf den Screen",
...
#  include "myerrs_ger.h"
  ...
  DOSERR(116),"Benötiges Argument fehlt",
  DOSERR(117),"Argument hinter '=' fehlt",
  DOSERR(118),"Zu viele Argumente",
  DOSERR(119),"Anführungszeichen nicht korrekt",
  DOSERR(120),"Argumentzeile fehlerhaft oder zu lang",
  DOSERR(121),"File ist nicht ausführbar",
  DOSERR(122),"alte Library für die DOS-Befehle",
  ...
  DOSERR(210),"Objektname ungültig",
  DOSERR(211),"??? Ungültiger Objekt-Lock ???",
  DOSERR(212),"Typ des Objekt nicht korrekt",
  DOSERR(213),"Disk nicht validiert",
  DOSERR(214),"Disk ist schreibgeschützt",
  DOSERR(215),"Umbenennen über Devicegrenzen nicht möglich",
  ...
  DOSERR(222),"Objekt ist löschgeschützt",
  DOSERR(223),"File ist schreibgeschützt",
  DOSERR(224),"File ist lesegeschützt",
  DOSERR(225),"Keine gültige DOS-Disk",
  DOSERR(226),"Keine Diskette im Laufwerk",
  DOSERR(232),"??? Keine Einträge mehr im Verzeichnis ???",
